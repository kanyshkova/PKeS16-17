...
/**
* @brief Maps the raw data value on m/s^2
*
* Determine the default configuration of the accelaration sensor and
* calculate a SI based representation
*/

float MPU9150_calculate_acc_SI(int raw_value){
  //nehmen des wertes für 0° zur vertikalen zur Grav. als sicheren Wert und und 0 der sowieso sicher ist erstellen einer linearen Funktion um
  //die Werte in m/s^2 zu erhalten
  float SI_value;
  SI_value = 0.000598 * raw_value;
  return SI_value;
}
